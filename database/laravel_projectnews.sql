...
--
-- База данных: `laravel_projectnews`
--
...
(1, 'Образование', '2020-12-23', '2020-12-23'),
(2, 'Медицина', '2020-12-23', '2020-12-23'),
(3, 'Политика', '2020-12-23', '2020-12-23');
...
(1, 'Какие ограничения отменяются или смягчаются в Эстонии с 3 мая?', 'Напомним, что первыми с 26 апреля были смягчены правила для занятий спортом, тренировок и деятельности по интересам на свежем воздухе.\r\n\r\nС 3 мая частично открываются общеобразовательные школы и магазины, также можно будет есть на открытых террасах заведений общепита, учитывая ограничения, связанные с часами работы, правилами передвижения, рассадки и заполняемости. Если эпидемиологическая обстановка позволит, в течение мая ограничения будут ослаблены дополнительно.\r\n\r\nПри движении в общественных помещениях останутся в силе правило 2+2 и обязанность носить маску.', '136.jpg', 1, '2021-05-03', '2021-05-03'),
(2, 'Более сотни эстонских мотоциклистов открыли сезон', 'В субботу, 1 мая, в полдень около 170 мотоциклистов собрались, чтобы организовать мотопарад в Раквере. Этим заездом они хотели привлечь внимание к безопасности мотоциклистов на дороге и проинформировать водителей о том, что двухколесные транспортные средства снова участвуют в дорожном движении.', '137.jpg', 2, '2021-05-03', '2021-05-03'),
(3, 'Правительство одобрило реформу системы поддержки детей с особыми потребностями', 'Правительство на прошлой неделе поддержало предложения по обновлению системы поддержки детей с особыми потребностями, как было указано в коалиционном договоре. Министерство социальных дел и министерство образования и науки совместно запустят реформу системы поддержки детей с особыми потребностями, цель которой – обеспечить детям получение более полноценной помощи быстрее и результативнее.', '135.jpg', 3, '2021-05-03', '2021-05-03');
