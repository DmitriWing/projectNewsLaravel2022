...
<div class="col-xl-6 col-lg-6 mb-4">
  <div class="card">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Category Manager - EDIT</h6>
    ...
    <!-- <div class="table-responsive"> -->
      ...
      <div class="card-body">
        <form action="{{url('editcategory/'.$category->id)}}" method="POST">
        	@csrf
		      <input class="form-control mb-3" type="text" name="name" placeholder="Category name" value="{{$category->name}}">
